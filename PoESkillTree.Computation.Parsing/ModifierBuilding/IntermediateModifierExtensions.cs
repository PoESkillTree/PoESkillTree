...
namespace PoESkillTree.Computation.Parsing.ModifierBuilding
{
    ...
    public static class IntermediateModifierExtensions
    {
        ...
        public static IIntermediateModifier MergeWith(this IIntermediateModifier left, IIntermediateModifier right)
        {
            ...
            IEnumerable<IntermediateModififerEntry> entries = right.Entries.Select(r => Merge(leftEntry, r));
            return new SimpleIntermediateModifier(entries.ToList(), ConvertStat, ConvertValue);
        }

        private static IntermediateModififerEntry Merge(IntermediateModififerEntry left,
            IntermediateModififerEntry right)
        {
            ...
            return new IntermediateModififerEntry()
