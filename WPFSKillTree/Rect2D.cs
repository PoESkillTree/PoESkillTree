...
namespace POESKillTree
{
    ...
    public struct Rect2D
    {
        ...
        public double Right { get { return Max.X; } }

        public double Top { get { return Min.Y; } }

        public double Bottom { get { return Max.Y; } }

        public double Width { get { return Max.X - Min.X; } }

        public double Height { get { return Max.Y - Min.Y; } }

        public Vector2D Center { get { return ( Min + Max ) / 2; } }
       ...
       // public Vector2D RandomPoint( Random r ) { return new Vector2D( r.NextBetween( Left, Right ), r.NextBetween( Top, Bottom ) ); }
        ...
        public bool IsPoint { get { return Min == Max; } }
