...
namespace PoESkillTree.Computation.Console
{
    public static class SkillDefinitions
    {
        public static readonly IReadOnlyList<SkillDefinition> Skills = new[]
        {
            ...
            new SkillDefinition("Herald of Ice", 12, new Keyword[0], true), 
            new SkillDefinition("Herald of Ash", 13, new Keyword[0], true), 
            new SkillDefinition("Herald of Thunder", 14, new Keyword[0], true), 
        };
