...
{
    /// <summary>
    /// <see cref="ISuspendableEventViewProvider{T}"/> for <see cref="ICalculationNode"/>s that allows disposing
    /// the nodes in <see cref="ISuspendableEventViewProvider{T}"/> and manually raising
