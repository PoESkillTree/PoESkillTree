...
namespace PoESkillTree.GameModel.Skills
{
    public class SkillDefinitionExtensionCollection : IEnumerable<(string, SkillDefinitionExtension)>
    {
        ...
        public void Add(string skillId, params (string name, SkillPartDefinitionExtension extension)[] parts)
            => Add(skillId, new SkillPartDefinitionExtension(), parts);

        public void Add(string skillId, SkillPartDefinitionExtension commonExtension,
        ...
        public void Add(string skillId, IReadOnlyDictionary<string, IEnumerable<Entity>> buffStats,
            params (string name, SkillPartDefinitionExtension extension)[] parts)
        ...
        public void Add(string skillId, SkillPartDefinitionExtension commonExtension,
            ...
            params (string name, SkillPartDefinitionExtension extension)[] parts)
            => _collection.Add((skillId, new SkillDefinitionExtension(commonExtension, buffStats, parts)));
    }
}